    ...
    PVAudioPlayer.addEventListener(Event.RemotePlaySearch, (e) => {
      ...
      */
      ...
      /*
        ...
        3) query, search queue for a podcast title in the queue that includes that query,
           and if found, play the first match
        4) query, search subscribed podcasts for a podcast title that includes that query,
           and if found, play the first match
