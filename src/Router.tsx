...
import {
  ...
  SettingsScreenDesign,
  SettingsScreenDownloadsHistory,
...
const MoreNavigator = createStackNavigator(
  {
    ...
    [PV.RouteNames.SettingsScreenDesign]: SettingsScreenDesign,
    [PV.RouteNames.SettingsScreenDownloadsHistory]: SettingsScreenDownloadsHistory,
