...
export const Emails = {
  CONTACT_US: {
    ...
    body: `If you are reporting an issue, please provide your device type and/or brand and steps to reproduce the bug if possible. Thank you! / Platform: ${
      Platform.OS
  ...
  CHECKOUT_ISSUE: {
    ...
    body: `Please explain your issue below and we'll get back to you as soon as we can. / Platform: ${
      Platform.OS
    } / Version: ${getVersion()} build ${getBuildNumber()}`
  },
  REQUEST_PODCAST: {
