...
const mediaMoreButtons = (
  ...
  if (item.ownerId && item.ownerId === loggedInUserId) {
    buttons.push(
      {
        accessibilityHint: translate('ARIA - Tap to edit this clip'),
      ...
      {
        accessibilityHint: translate('ARIA - Tap to delete this clip'),
  ...
  if (isDownloaded) {
    buttons.push({
      accessibilityHint: translate('ARIA - Tap to play'),
      key: PV.Keys.play,
      text: translate('Play'),
      onPress: async () => {
        await handleDismiss()
    ...
    buttons.push({
      accessibilityHint: translate('ARIA - Tap to stream'),
      key: PV.Keys.stream,
    ...
    if (handleDownload) {
      buttons.push({
        accessibilityHint: translate('ARIA - Tap to download this episode'),
  ...
  if (!item.addByRSSPodcastFeedUrl) {
    buttons.push(
      {
        accessibilityHint: translate('ARIA - Tap to add this next in your queue'),
      ...
      {
        accessibilityHint: translate('ARIA - Tap to add this last in your queue'),
    ...
    if (!Config.DISABLE_ADD_TO_PLAYLIST && isLoggedIn) {
      buttons.push({
        accessibilityHint: translate('ARIA - Tap to add to your playlist'),
    ...
    if (!Config.DISABLE_SHARE) {
      buttons.push({
        accessibilityHint: translate('ARIA - Tap to share'),
        key: PV.Keys.share,
  ...
  if (isDownloaded) {
    buttons.push({
      accessibilityHint: translate('ARIA - Tap to delete this downloaded episode'),
  ...
  if (includeGoToPodcast) {
    buttons.push({
      accessibilityHint: translate('ARIA - Tap to go to this podcast'),
